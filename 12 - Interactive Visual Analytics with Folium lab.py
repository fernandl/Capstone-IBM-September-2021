...
for index,site in launch_sites_df.iterrows():
    ...
    circle= folium.Circle(coordinate, radius=50, color='orange', fill=True).add_child(folium.Popup(name))
    site_map.add_child(circle)           
...
for index,site in launch_sites_df.iterrows():
    ...
    marker = folium.Marker(coordinate,icon= icon) 
    site_map.add_child(marker)
...
for index, record in spacex_df.iterrows():
    ...
    marker = folium.Marker(coordinates, icon = icon)    
...
# Coastline from VAFB SLC-4E, Lat: 34.63631  Lon:-120.62482

launch_site_lat =  34.632834
launch_site_lon = -120.610746
coastline_lat = 34.63783
coastline_lon = -120.62452
vafb_distance_coastline = calculate_distance(launch_site_lat, launch_site_lon, coastline_lat, coastline_lon)
vafb_distance_coastline
...
vafb_coast_coord = [coastline_lat, coastline_lon]
distance_marker = folium.Marker(
    vafb_coast_coord,
    icon=DivIcon(
        icon_size=(20,20),
